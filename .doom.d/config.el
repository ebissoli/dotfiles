...
(setq calibredb-root-dir "/home/enzobissoli/Calibre")
...
(setq calibredb-virtual-library-alist '(
                                        ("1. Faculdade" . "2020.1")))
(map! :after evil-repeat
      :map calibredb-search-mode
      :nv "." #'calibredb-find-file) ;; apps-calibre mode

(use-package mathpix
  :custom ((mathpix-app-id "enzogurgel15_gmail_com_46b290_4aff5e")
           (mathpix-app-key "b71c74079eba189aa2c5"))

  :bind
  ("C-x m" . mathpix-screenshot)) ;; apps -mathpix
...
(map!
    :after calibredb
    :map calibredb-searchmode-map
    :leader
    :desc "Calibredb Dispatch"
    "C" #'calibredb-dispatch)
