...
(after! (:or org-capture org-agenda org)
    (setq org-capture-templates
      (doct '(("UNI" :keys "u"
               :file "~/roam_notes/notes/UFPE/2021.2/2021.2.org"
               :prepend t
               :template ("* %{todo-state} %?"
                          "%i %a")
              ...
              ("Bookmarks" :keys "b"
               ...
               :template ("* %^{Description} %?"
                          "%i"))
              ("Appointments" :keys "p"
               :file "~/Insync/roam_notes/notes/UFPE/2021.2/2021.2.org"
               :append t
               ...
               :template ("* %^{Description} %?"
                          "%i"))
              ("Projects" :keys "P"
               :file "~/roamnotes/notes/UFPE/2021.2/2021.2.org"
               :append t
               :headline "Projects"
               :type entry
               :template ("* %^{Description} %?"
...
(defun my-open-calendar ()
  ...
  (cfw:open-calendar-buffer
   ...
   (list
    ...
    (cfw:org-create-file-source "cal" "~/roam_notes/notes/UFPE/2021.2/2021.2.org" "Blue")  ; other org source
    )))
#+end_src
** Roam
#+begin_src elisp
