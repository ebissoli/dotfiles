...
(setq org-agenda-custom-commands
      '(("o" "Overview of the day"
         (
          (org-ql-block '(and (tags "MEETING")
                              (scheduled :to "1")
                              )
                        ((org-ql-block-header "Meetings for tomorrow")))
          (org-ql-block '(and (inherited-tags "UFPE")
                              (deadline :to "7"))
                        ((org-ql-block-header "CIN stuff")))
          (org-ql-block '(and (inherited-tags "RECUR")
                              (scheduled :on today))
                        ((org-ql-block-header "Recurrent Tasks")))
          (org-ql-block '(and (inherited-tags "EVENTS")
                              (scheduled :to "7"))
                        ((org-ql-block-header "Events in the future")))
