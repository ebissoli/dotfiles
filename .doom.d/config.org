...
;;                 :todo "DOING")  ; Items that have this TODO keyword
;;          (:name "Important"
...
(map!
        :g "C-M-]" nil
        :desc "Move into ()'s" :n "C-M-]" #'sp-down-sexp)

(map!
        :g "M-]"
        :desc "Move out ()'s'" :n "M-]" #'sp-up-sexp)
#+end_src
**** Same depth movement
#+begin_src emacs-lisp
(map!
...
(map!
        :g "M-n" nil
        :desc "next context" :n "M-n" #'sp-end-of-previous-sexp)
(map!
        :g "C-M-n" nil
        :desc "previous in context" :n "C-M-n" #'sp-beginning-of-next-sexp)
#+end_src
...
(map!
        :g "C-M-r" nil
        :desc "next symbol" :n "C-M-r" #'sp-next-sexp)

(map!
        :g "M-r" nil
        :desc "prev symbol" :n "M-r" #'sp-backward-sexp)
...
(map!
    :g "C-M-k" nil
    :desc "kill whole line" :no "C-M-k #'sp-kill-whole-line)
