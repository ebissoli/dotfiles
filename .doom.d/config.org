...
(map!
    :g "C-M-v" nil
    :desc "Move out function hierarchy" :n "M-v" #'sp-backward-up-sexp)
(map!
    :g "M-v" nil
...
(map!
        :g "C-M-r" nil
        :desc "Move outside of function hierarchy" :n "C-M-r" #'sp-backward-down-sexp)
(map!
        :g "C-M-/" nil
...
;; (map!
;;         :g "C-M-r" nil
;;         :desc "next symbol" :n "C-M-r" #'evil-previous-open-brace)
...
(map!
 :g "C-s" nil
 :desc "search symbol at point" :n "C-s" #'isearch-forward-symbol-at-point)
#+end_src
